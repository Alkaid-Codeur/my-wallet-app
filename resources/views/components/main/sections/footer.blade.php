		...
		<div class="py-8 md:py-12 border-t border-gray-200">
			<div class="md:flex justify-between items-center">
				...
				<div class="mb-3 md:mb-0">
					<h6 class="text-gray-800 font-medium mb-2">My Wallet</h6>
					<ul class="text-sm">
						<li class="mb-2">
							<a class="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out" href="{{route('register')}}">S'inscrire</a>
						</li>
						<li class="mb-2">
							<a class="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out" href="{{route('login')}}">Se connecter</a>
						</li>
					</ul>
				</div>
				<div class="md:mb-2">
					<h6 class="text-gray-800 font-medium mb-2">Souscrire</h6>
					<p class="text-sm text-gray-600 mb-4">Get the latest news and articles to your inbox every month.</p>
					<form>
						<div class="flex flex-wrap mb-4">
							<div class="w-full"><label class="block text-sm sr-only" for="newsletter">Email</label>
								<div class="relative flex items-center max-w-xs"><input id="newsletter" type="email" class="form-input w-full text-gray-800 px-3 py-2 pr-12 text-sm" placeholder="Your email" required="">
									<button type="submit" class="absolute inset-0 left-auto"
			...
			<div class="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
				<ul class="flex mb-4 md:order-1 md:ml-4 md:mb-0">
					<li>
						<a class="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out"
				...
				<div class="text-sm text-gray-600 mr-4">Made by <a class="text-blue-600 hover:underline"
						href="https://cruip.com/">Alkaid-Codeur</a>. All rights reserved.</div>
				</div>
			</div>
		</div>
	</div>
