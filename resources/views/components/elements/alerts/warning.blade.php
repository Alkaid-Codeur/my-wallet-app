...
<div x-data="{open:true}">
	<div class="justify-between bg-yellow-100 rounded-lg py-5 px-6 mb-3 text-lg font-semibold text-yellow-700 inline-flex items-center w-full" role="alert" x-show="open">
